...
function sanjiao() {
    ...
    //Inaccurate normals just for testing.
    normals3.push (
        normalize(vec3(-2.5, -0.5, 0.5)),
        normalize(vec3(-1.5, -0.5, 0.5)),
        normalize(vec3(-2.0, 0.25, 0)),
        normalize(vec3(-1.5, -0.5, -0.5)),
        normalize(vec3(-2.5, -0.5, -0.5)));
    ...
    indices3.push(
        ...
        3, 4, 2,  // back triangle
        4, 0, 2, // left triangle
        4, 0, 1, 4, 1, 3 //bottom left triangle and right triangle
    );
...
function initTexture() {
    ...
    var pyramidImage = new Image();
    squareImage.onload = function () { handleTextureLoaded(squareImage, squareTexture); }
    pyramidImage.onload = function () { handleTextureLoaded(pyramidImage, pyramidTexture); }

    squareImage.src = "Material/marble10.png";
    pyramidImage.src = "Material/Image.jpg";
}
